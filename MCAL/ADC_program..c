...
/******************************************************************/
volatile u16 ADC_u16ADCValue;                       //extern
volatile u8 ADC_u8BinaryFlagConversionComplete=0;   //extern
/******************************************************************/
static volatile u16 ADC_Arru16ADCReadFreeRunningMode[8]={0};
static volatile u16 ADC_u16AutoTriggerRead;

//   const  //
volatile u16* const ADC_pu16AutoTriggerRead=&ADC_u16AutoTriggerRead;    
volatile u16* const ADC_pu16_ArrayReadFreeRunningModed=ADC_Arru16ADCReadFreeRunningMode;
/*******************************************************************/
...
{
	if (Copy_enumTriggermode!=Free_Running_mode)
	{
...
static void ADC_vFreeRunningModeORAutiTrigger(void)
{
 ...
 void ADC_vFreeRunningModeORAutiTriggerInit(void)
 {
	 /* start conversion*/
	 SET_BIT(ADCSRA,ADSC);
